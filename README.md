...
**PS! In order for the web page to be generated and run correctly on your local machine, open the settings panel and tick the checkbox "Use Local Web Server"**
